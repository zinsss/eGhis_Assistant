...
import main
from eAmodules import eAwinauto, eAutils, eApopup, eAmacros, eAinput
...
def flu_group_org(self, ptjmno:str):
    ...
    # 연령만을 가지고 그룹으로 나눔. (0: 일반독감, 1: 75세이상, 노인, 2: 70~74, 노인, 3: 65~69, 노인, 4: 소아(1회/2회접종 구분X))    
